<?php
  ...
  // je récupére dans les paramètres de ma fonction les valeurs passées dans l'appel de cette fonction dans le fichier Ctrl_InsertDatasReg.php 
  ...
  function selectPseudo($connectBdd, $pseudo){    
    ...
    // Je selectionne la colonne pseudo dans la table users_registred dont la valeur et égal à $pseudo (càd le pseudo saisi par l'utilisateur).
    ...
    // PDO::FETCH_OBJ, retourne un objet anonyme avec des noms de propriété qui correspondent aux noms de colonne retournés dans votre jeu de résultats.
